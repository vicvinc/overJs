...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Login = React.createClass({
		...
		popHandler: function popHandler() {
	...
	var app = React.createClass({
		...
		nullMsgState: function nullMsgState() {
			this.setState({ errMsg: 'user name or password is null! ' });
		},
		loginHandler: function loginHandler(r) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement('input', { name: 'UserPwd', className: 'user-pwd', type: 'password',
					placeholder: 'Your password', ref: 'userPwd' }),
				React.createElement(Login, { onClick: this.loginHandler }),
				React.createElement(
					'span',
					null,
					this.state.errMsg
...
/***/ function(module, exports) {
	...
	/* 
	* @Author: Administrator
	* @Date:   2015-09-23 15:37:49
	* @Last Modified by:   Administrator
	* @Last Modified time: 2015-09-23 16:05:06
	*/

	/* 
	* @Author: Administrator
	* @Date:   2015-09-21 16:30:10
	* @Last Modified by:   Administrator
	* @Last Modified time: 2015-09-21 16:30:27
	*/
